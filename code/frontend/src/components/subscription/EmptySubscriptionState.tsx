...
import { Sprout, Check, ArrowRight, Cloud, Smartphone } from 'lucide-react';
    ...
    <>
      <div className="max-w-3xl mx-auto px-4 py-12 md:py-20">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-semibold mb-3">Welcome to Hobby Farm Planner</h1>
        ...
        <Card className="p-8 mb-6">
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              <h2 className="text-xl font-semibold">Starter Plan (Free)</h2>
