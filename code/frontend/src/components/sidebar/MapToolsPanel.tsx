import { MapPin, Route, Square, Trees, Warehouse, Home, Droplets, DoorOpen } from "lucide-react";
...
export function MapToolsPanel({ onAddMarker, onDrawPath, onDrawZone }: MapToolsPanelProps) {
  ...
  const markerTypes = [
    ...
    { type: 'water', label: 'Water Source', icon: Droplets, color: '#0EA5E9' },
    { type: 'gate', label: 'Gate', icon: DoorOpen, color: '#8B5CF6' },
