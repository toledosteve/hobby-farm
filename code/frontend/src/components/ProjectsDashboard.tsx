      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        {projects.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h2 className="mb-2">No farms yet</h2>
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              Create your first farm to start planning your land, viewing soil data, and marking important features.
            </p>
