import { MapPin, Plus, Droplets, CheckSquare, Trees, Egg, Calendar as CalendarIcon } from "lucide-react";
  ...
  return (
    <div className="p-8 space-y-8">
      ...
      <div>
        ...
        <p className="text-base text-muted-foreground">Here&apos;s what&apos;s happening on your farm today.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <MetricCard
          ...
          subtitle="Increased last month"
          colorScheme="primary"
        />
        <MetricCard
          title="Maple Taps Active"
          value="126"
          icon={Trees}
        ...
        />
        <MetricCard
          title="Eggs This Week"
          value="84"
          icon={Egg}
          trend={{ value: "-3.2%", direction: "down", isPositive: false }}
        ...
        <DashboardCard title="Active Modules" icon={Droplets}>
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer"
              ...
              <Button size="lg" className="w-full" onClick={onOpenMapleSugaring}>
                Open Module
              </Button>
            </div>
            ...
            <div className="p-4 rounded-lg border border-border hover:border-primary/50 transition-colors cursor-pointer"
              ...
              <Button size="lg" className="w-full" onClick={onOpenPoultry}>
                Open Module
              </Button>
            </div>
