import { Droplets, Lock, TreePine } from "lucide-react";
...
export function ModulesScreen({ onOpenModule }: ModulesScreenProps) {
  const modules: Module[] = [
    ...
    {
      id: 'trees',
      name: 'Trees & Land Stewardship',
      icon: '🌲',
      description: 'Inventory trees, plan plantings, and discover suitable species for your property',
      enabled: true,
      stats: [
        { label: 'Total Trees', value: '5' },
        { label: 'Native Species', value: '4' },
    ...
    },
    {
      ...
      enabled: true,
      stats: [
        { label: 'Active Hives', value: '0' },
        { label: 'Honey Harvested', value: '0 lbs' },
        { label: 'Last Inspection', value: 'None' },
      ],
    },
    {
      id: 'orchard',
      ...
      enabled: true,
      stats: [
        { label: 'Fruit Trees', value: '0' },
        { label: 'Varieties', value: '0' },
        { label: 'Next Harvest', value: 'TBD' },
      ],
    },
    {
      id: 'livestock',
